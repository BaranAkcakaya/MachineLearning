...
# Adım 1 - Convolution
#input_shape = (64, 64, 3)=buradaki 3 renkli oldugu ıcın 3 katmandan olusacak
#64,64 ise resmi bu piksele donusturecek
...
from keras.preprocessing.image import ImageDataGenerator#resim okumaya yarayan kutuphane
#ImageDataGenerator icindekş kısı resim işleme ile ilgili filtreler
#shear yana bukme
#zoom yaklasıcagı gibi
